...
{
    public class VeFileNode : VeNode
    {
        public VeFileNode()
        {
        }
        ...
        protected VeFileNode(Util.Eq2Reader reader, Util.StreamingContext context) : base(reader, context)
        {
            byte classVersion = context.ClassVersions[typeof(VeFileNode)];
