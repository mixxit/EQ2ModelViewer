...
{
    public class VeResourceNode : VeNode
    {
        public VeResourceNode()
        {
        }
        ...
        protected VeResourceNode(Util.Eq2Reader reader, Util.StreamingContext context) : base(reader, context)
        {
        }
    }
}
