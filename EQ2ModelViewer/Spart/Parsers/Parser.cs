...
namespace Spart.Parsers
{
	...
	public abstract class Parser
	{
		...
		public static AlternativeParser operator | (char left, Parser right)
		{
			return Ops.Alternative(left, right);
		}

        
		public static AlternativeParser operator | (string left, Parser right)
		{
			return Ops.Alternative(left, right);
		}


        public static AlternativeParser operator | (Parser left, char right)
		{
			return Ops.Alternative(left, right);
		}

        
        public static AlternativeParser operator | (Parser left, string right)
		{
			return Ops.Alternative(left, right);
		}
		...
		public static SequenceParser operator + (char left, Parser right)
		{
			return Ops.Seq(left, right);
		}
        ...
        public static SequenceParser operator + (Parser left, char right)
		{
			return Ops.Seq(left, right);
		}
        ...
        public Parser this[ActionHandler handler]
        {
            get
            {
                Parser clone = Clone();
        ...
        {
            return MemberwiseClone() as Parser;
        }
